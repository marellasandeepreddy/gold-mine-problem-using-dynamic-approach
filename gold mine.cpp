...
max(max(rightUpperDiagonal, rightLowerDiagonal), right); 
} 
...
{ 
 ...
 int goldCollected = collectGold(gold, i, 0, n, m); maxGold = 
max(maxGold, goldCollected); 
 } 
